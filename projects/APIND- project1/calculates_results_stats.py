...
def calculates_results_stats(results_dic):
    ...
    results_stats_dic_keys = ['n_dogs_img','n_match','n_correct_dogs','n_correct_notdogs','n_correct_breed']
    
    
    for key in results_stats_dic_keys:
        results_stats_dic[key] = 0
